...
$tool_path_1 --prok --gcode $opt_gcode --output $abs_rootdir/genemarks/query.lst --name query $abs_fna > $abs_rootdir/genemarks/gmsn.log
...
then
    ...
    cp $db_dir/default_hmm.mod $abs_rootdir/genemarks/query_hmm_heuristic.mod
fi

$tool_path_2 -r -f 3 -m $abs_rootdir/genemarks/query_hmm_heuristic.mod -o $abs_rootdir/genemarks/GeneMarkS_output.gff $abs_fna > $abs_rootdir/genemarks/gmhmmp.log

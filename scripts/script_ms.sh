...
$R_HOME/03_run_prodigal_meta.sh $FOLDER_PATH $G_CODE&>> $FOLDER_PATH/annolog/prodigal.log

echo "Gene Prediction 2 [4/12]" >> $FOLDER_PATH/temp/process.log

echo "********** GenemarkS **********" >> $FOLDER_PATH/annolog/genemarks.log
$R_HOME/04_run_genemarks_short.sh -r $FOLDER_PATH -g $G_CODE &>> $FOLDER_PATH/annolog/genemarks.log
